...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_account'])) {
    ...
    if (deleteUser($username)) {
        ...
        header('location: userlogin.php?message=account_deleted');
        exit();
    } else {
        $message = $config['messages']['delete_error'];
        $messageType = "error";
    }
}
...
<head>
    ...
    <script>
        function confirmDelete() {
            return confirm("<?php echo $config['messages']['delete_confirm']; ?>");
        }
    </script>
    <style>
        body {
        ...
        .success {
            ...
            border-left: 4px solid
                <?php echo $config['colors']['success']; ?>
            ;
        }
        ...
        select:focus {
            outline: none;
            border-color:
                <?php echo $config['colors']['primary']; ?>
            ;
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="text" name="fullName" value="<?php echo htmlspecialchars($userData['fullName'] ?? ''); ?>"
                    required>
            </div>

            <div class="form-group">
                <label>Username</label>
                <input type="text" value="<?php echo htmlspecialchars($userData['username'] ?? ''); ?>" class="disabled"
                    disabled>
            </div>
            ...
            <div class="field-row">
                <div class="form-group">
                    ...
                    <input type="tel" name="phonenumber"
                        value="<?php echo htmlspecialchars($userData['phonenumber'] ?? ''); ?>" required>
                </div>
            ...
            <div class="field-row">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="emergencyContact"
                        value="<?php echo htmlspecialchars($userData['emergencyContact'] ?? ''); ?>" required>
                </div>
            </div>
            ...
            <div class="delete-section">
                <div class="delete-warning">
                    ...
                    Once you delete your account, all your data will be permanently removed. This action cannot be
                    undone.
                </div>
