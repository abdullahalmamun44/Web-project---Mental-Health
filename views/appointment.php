    ...
    <div class="container">
        ...
        <div class="content">
            <div class="card">
                ...
                <form method="POST" action="../controllers/appointmentController.php" id="appointmentForm" onsubmit="return validateAppointment()">
                            ...
                            <div class="appointment-item <?php echo $appointment['status']; ?>">
                                ...
                                <div class="appointment-details">
                                    ...
                                    <?php if($appointment['therapist_name']): ?>
                                        <div class="therapist-info">
                                            <div class="therapist-name">Dr. <?php echo htmlspecialchars($appointment['therapist_name']); ?></div>
                                            <?php if($appointment['specialization']): ?>
                                                <div class="therapist-specialization"><?php echo htmlspecialchars($appointment['specialization']); ?></div>
                                            <?php endif; ?>
                                    ...
                                    <p><strong>Booked on:</strong> <?php echo date('d M Y h:i A', strtotime($appointment['created_at'])); ?></p>
                                </div>
                                
                                <?php if($appointment['status'] == 'pending'): ?>
                                    <form method="POST" action="../controllers/cancelAppointment.php" style="margin-top: 10px;" class="cancelForm">
                ...
                <?php foreach($therapists as $therapist): ?>
                    <div class="therapist-info" style="border: 1px solid #ddd; padding: 15px;">
                        ...
                        <div class="therapist-specialization">
                            <strong>Specialization:</strong> <?php echo htmlspecialchars($therapist['specialization']); ?><br>
                            ...
                            <strong>Available Days:</strong> <?php echo htmlspecialchars($therapist['available_days']); ?><br>
